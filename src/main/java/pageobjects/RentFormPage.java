...
public class RentFormPage {
    ...
    private final By arrowTimeRent =  By.className("Dropdown-arrow");
    private final By listTimeRent =  By.className("Dropdown-control");
    private final By colorBlack = By.xpath(".//input[@id='black']");
    private final By comment =  By.xpath(".//input[@placeholder='Комментарий для курьера']");
    private final By order =  By.className("Button_Button__ra12g");
    private final By yes =  (By.xpath(".//button[(@class ='Button_Button__ra12g Button_Middle__1CSJM' and text()='Заказать')]"));
